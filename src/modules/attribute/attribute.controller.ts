...
export class AttributeController {
	...
	@UseGuards(AuthGuard)
	update_status_attribute(@Param('id') id: string, @Body() data: { status: boolean }, @Req() request: any) {
	...
	@UseGuards(AuthGuard)
	get_values_attribute(@Param('id') id: string) {
	...
	update_attribute(@Param('id') id: string, @Body() editAttributeDto: EditAttributeDto) {
